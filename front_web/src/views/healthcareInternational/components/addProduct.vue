          ...
          <el-row type="flex">
            <el-col :span="20" :offset="2">
              ...
              <el-col :span="4" v-if="isShowSort()">
                <el-form-item label="排序" prop="hot_sort">
                  <el-col :span="4">
          ...
          <el-row type="flex">
            <el-col :span="6" :offset="2">
              <el-form-item label="产品分类" prop="goods_tag">
                <el-select v-model="form.goods_tag" clearable placeholder="请选择" style="width:80%;">
...
<script>
    ...
    import { addproduct,getcategorylist } from "@/api/healthcareInternational.js";
    export default{
        data() {
            ...
            const secondcategory = (rule,value,callback) => {
                if(value == ''){
                    this.form.second_category_id = '-1'
                    callback();
                } else {
                    callback();
                }
	...
	　　　	 
        ...
        methods: {
            ...
            mainimgSuccess(res,file,fileList) {
              ...
              //this.form.main_img_show = this.baseurl + res.data;
              console.log(this.form.main_img)
            },
            hotimgSuccess(res,file,fileList) {
              this.form.hot_img = res.data;
              //this.form.hot_img_show = this.baseurl + res.data;
