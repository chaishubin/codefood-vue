<template>
    <div id="editseller">
        <div class="formwarp">
            <el-dialog width="80%" top="5vh" :before-close="BcloseDialog" title="编辑店铺" :visible.sync="dialogFormVisible" :close-on-click-modal="false"
                       :lock-scroll="true">
...
<script>
    import { getsellerinfo,editseller } from "@/api/seller.js";
    export default{
        data() {
            ...
            return {
                ...
                rules: {
//                    user_mobile: [{required: false, trigger: "blur", validator: mobile}],
//                    username: [{required: false, trigger: "blur", validator: words_20}],
//                    password: [{required: false, trigger: "blur", validator: password}],
//                    password_confirmation: [{required: false, trigger: "blur", validator: confirm_pass}],
//                    address: [{required: false, trigger: "blur", validator: words_100}],
//                    shop_name: [{required: false, trigger: "blur", validator: words_20}],
...
//                    console.log(res.data.data)
                    ...
                    _this.form.user_mobile = result.user_mobile;
                    ...
                    _this.form.shop_name = result.shop_name;
                    _this.form.shop_logo = result.shop_logo;
...
//                    console.log(valid)
                    if(valid){
                        editseller(this.id,_this.form.user_mobile,this.form.username,this.form.password,this.form.password_confirmation,this.form.address,this.form.shop_name,this.form.shop_logo,this.form.status).then(res => {
                            console.log(res)
