<template>
  <div id="adAdd">
    <el-dialog width="80%" top="5vh" :before-close="BcloseDialog" title="添加广告" :visible.sync="dialogFormVisible" :close-on-click-modal="false"
      :lock-scroll="true">
...
<script>
    import { platformlist,addbanner,bannerposition,categorylist } from '@/api/adSet.js'
    export default{
        data() {
        ...
        methods: {
            ...
            submitform() {
                ...
                this.$refs.addForm.validate(valid => {
                    console.log(valid)
                    if(valid){
                        addbanner(this.form.name,this.form.platform,this.form.position,this.form.category_id,this.form.sort,this.form.status,this.form.lifecycle,this.form.url,this.form.img).then(res => {
                            console.log(res)
            ...
            changetime(val){
                this.form.lifecycle = val;
                console.log(this.form.lifecycle);
            },
            //全选
...
<style>
    #adAdd .avatar-uploader .el-upload {
    ...
    #adAdd .avatar-uploader .el-upload:hover {
        border-color: #409EFF;
    }
    #adAdd .avatar-uploader-icon {
        font-size: 28px;
        color: #8c939d;
        width:100%;
        height:100%;
    ...
    #adAdd .el-date-editor--daterange.el-input__inner{
      width:75%;
    }
</style>